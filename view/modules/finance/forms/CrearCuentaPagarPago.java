...
public class CrearCuentaPagarPago extends JDialog implements ActionListener {
    ...
    public CrearCuentaPagarPago(AplicationContext context, Dahsboard dahsboard) {
        ...
        {
            JLabel lbCrear = new JLabel("Registrar Pago - Cuenta por Pagar");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnGuardar) {
            ...
            try {
                ...
                boolean ok = false;
                try {
                    String res = context.getCuentaPagarController().registrarPago(idCuenta, fecha, monto);
