...
public class CrearReporteCXP extends JDialog implements ActionListener {
    ...
    public CrearReporteCXP(AplicationContext context, Dahsboard dahsboard) {
        ...
        {
            JLabel lbCrear = new JLabel("Crear Reporte Cuentas Por Pagar");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src instanceof JButton && "Crear".equals(((JButton) src).getText())) {
            try { 
                ...
                String RUTA = "reportes/reporte_cuentras_pagar"  + fecha + ".pdf";
                ReporteCuentasPagar reporte = reporteCuentaPagarController.generarReporte();
                boolean ok = false;
                try {
