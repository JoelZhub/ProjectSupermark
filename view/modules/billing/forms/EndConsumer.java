...
public class EndConsumer extends JPanel implements ActionListener {
	...
	private JLabel lbTitulo, lbSubTitulo, lbMetodoPago, lbSubtTotal, lbTotal, lbCajeroUsuario, lbTotalArticulos, lbFecha, lbDescripcion,
			itbisProducto, lbLogo, lbValor, lblNewLabel, lbRnc, lbFechaHoraActual, lbDireccion, lbComprobanteFiscal,
	...
	private void crearPanelContenido() {
		...
		panelContenido.setBounds(0, 479, 1040, 271);
	...
	private void crearPanelDescripcion() {
		...
		scrollPaneDescripcion.setBounds(60, 31, 288, 162);
	...
	private void crearLabels() {
		...
		lbRnc = new JLabel(RNCUtils.generarRNCConsumidorFinal());
		...
		lbDescripcion.setBounds(60, 0, 180, 21);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnGuardar) {
			...
			if(metoodPago.getSelectedItem() != null) {
				...
				String resultado = context.getFacturaController().agregarFactura(metodoPago, idCliente, cajeroId);
